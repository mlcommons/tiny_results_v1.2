...
static const q7_t const_fold_opt__53[128 * 640] = CONST_FOLD_OPT__53;

static const q7_t const_fold_opt__59[640 * 128] = CONST_FOLD_OPT__59;

static const q7_t const_fold_opt__58[128 * 128] = CONST_FOLD_OPT__58;

static const q7_t const_fold_opt__57[8 * 128] = CONST_FOLD_OPT__57;
...
static const q7_t const_fold_opt__54[128 * 128] = CONST_FOLD_OPT__54;

static const q7_t const_fold_opt__62[128 * 8] = CONST_FOLD_OPT__62;
...
arm_fully_connected_q7((scratch_buffer + 640) /* Relu__5:0 */, const_fold_opt__60 /* const_fold_opt__60 */, 128 /* dim_vec */, 128 /* num_of_rows */, 5 /* bias_shift */, 6 /* out_shift */, functional_1_dense_1_biasadd_readvariableop_resource /* functional_1/dense_1/BiasAdd/ReadVariableOp/resource */, (scratch_buffer + 0) /* Add__13:0 */, col_buffer /* vec_buffer */);
arm_relu_q7((scratch_buffer + 0) /* Add__13:0 */, 1 * 128 /* size */);
arm_fully_connected_q7((scratch_buffer + 0) /* Relu__10:0 */, const_fold_opt__58 /* const_fold_opt__58 */, 128 /* dim_vec */, 128 /* num_of_rows */, 3 /* bias_shift */, 5 /* out_shift */, functional_1_dense_2_biasadd_readvariableop_resource /* functional_1/dense_2/BiasAdd/ReadVariableOp/resource */, (scratch_buffer + 128) /* Add__18:0 */, col_buffer /* vec_buffer */);
arm_relu_q7((scratch_buffer + 128) /* Add__18:0 */, 1 * 128 /* size */);
arm_fully_connected_q7((scratch_buffer + 128) /* Relu__15:0 */, const_fold_opt__56 /* const_fold_opt__56 */, 128 /* dim_vec */, 128 /* num_of_rows */, 2 /* bias_shift */, 3 /* out_shift */, functional_1_dense_3_biasadd_readvariableop_resource /* functional_1/dense_3/BiasAdd/ReadVariableOp/resource */, (scratch_buffer + 0) /* Add__23:0 */, col_buffer /* vec_buffer */);
arm_relu_q7((scratch_buffer + 0) /* Add__23:0 */, 1 * 128 /* size */);
arm_fully_connected_q7((scratch_buffer + 0) /* Relu__20:0 */, const_fold_opt__62 /* const_fold_opt__62 */, 128 /* dim_vec */, 8 /* num_of_rows */, 6 /* bias_shift */, 7 /* out_shift */, functional_1_dense_4_biasadd_readvariableop_resource /* functional_1/dense_4/BiasAdd/ReadVariableOp/resource */, (scratch_buffer + 128) /* Add__28:0 */, col_buffer /* vec_buffer */);
arm_relu_q7((scratch_buffer + 128) /* Add__28:0 */, 1 * 8 /* size */);
arm_fully_connected_q7((scratch_buffer + 128) /* Relu__25:0 */, const_fold_opt__57 /* const_fold_opt__57 */, 8 /* dim_vec */, 128 /* num_of_rows */, 6 /* bias_shift */, 5 /* out_shift */, functional_1_dense_5_biasadd_readvariableop_resource /* functional_1/dense_5/BiasAdd/ReadVariableOp/resource */, (scratch_buffer + 0) /* Add__33:0 */, col_buffer /* vec_buffer */);
arm_relu_q7((scratch_buffer + 0) /* Add__33:0 */, 1 * 128 /* size */);
arm_fully_connected_q7((scratch_buffer + 0) /* Relu__30:0 */, const_fold_opt__55 /* const_fold_opt__55 */, 128 /* dim_vec */, 128 /* num_of_rows */, 5 /* bias_shift */, 6 /* out_shift */, functional_1_dense_6_biasadd_readvariableop_resource /* functional_1/dense_6/BiasAdd/ReadVariableOp/resource */, (scratch_buffer + 128) /* Add__38:0 */, col_buffer /* vec_buffer */);
...
arm_fully_connected_q7((scratch_buffer + 0) /* Relu__40:0 */, const_fold_opt__54 /* const_fold_opt__54 */, 128 /* dim_vec */, 128 /* num_of_rows */, 6 /* bias_shift */, 7 /* out_shift */, functional_1_dense_8_biasadd_readvariableop_resource /* functional_1/dense_8/BiasAdd/ReadVariableOp/resource */, (scratch_buffer + 128) /* Add__48:0 */, col_buffer /* vec_buffer */);
arm_relu_q7((scratch_buffer + 128) /* Add__48:0 */, 1 * 128 /* size */);
arm_fully_connected_q7((scratch_buffer + 128) /* Relu__45:0 */, const_fold_opt__53 /* const_fold_opt__53 */, 128 /* dim_vec */, 640 /* num_of_rows */, 5 /* bias_shift */, 10 /* out_shift */, functional_1_dense_9_biasadd_readvariableop_resource /* functional_1/dense_9/BiasAdd/ReadVariableOp/resource */, (scratch_buffer + 256) /* Identity */, col_buffer /* vec_buffer */);
